...
include("../Mysql/conections.php");
$resultado = $db->prepare(getExamen());
...
//conexion exitosa
  ...
  $tipo = 'php'; // se cambiará conforme el examen, se puede cambiar por metodo post que reciba el tipo
  if ($resultado->num_rows) { //si la consulta genera registros
?>
    <form action="evaluador.php" method="post">
      <!-- mandaremos los datos escogidos -->
      <?php
      while ($fila = $res->fetch_assoc()) { //recorremos los registros obtenidos de la tabla
